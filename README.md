# Проект по автоматизации сайта  [Performance lab](https://www.performance-lab.ru/)

&nbsp;
![Performance lab](images/screens/company4.png)
&nbsp;
...
- ✓ _Переход на сайт Performance lab_
- ✓ _Наводим курсор на 'вакансии'_
- ✓ _Кликаем на 'Вакансии' в разделе 'Карьера в Перфоманс Лаб'_
- ✓ _Клик на 'Тестировщик (QA Engineer)' в разделе 'вакансии'_
- ✓ _Вводим рандомное имя_
- ✓ _Вводим рандомную фамилию_
...
- ✓ _Вводим фамилию_
- ✓ _Вводим почту_
- ✓ _Оставляем поле 'номер телефона' пустым_
- ✓ _Загружаем резюме_
- ✓ _Проверка формы_



## <img src="images/logo/Jenkins.svg" width="25" height="25"  alt="Jenkins"/></a> Jenkins <a target="_blank" href="https://jenkins.autotests.cloud/job/Krysov_Performance_lab/"> job </a>
<p align="center">
<a href="https://jenkins.autotests.cloud/job/Krysov_Performance_lab/"><img src="images/screens/jenkins4.png" alt="Jenkins"/></a>
</p>
...
## <img src="images/logo/Allure.svg" width="25" height="25"  alt="Allure"/></a> Отчет в <a target="_blank" href="https://jenkins.autotests.cloud/job/Krysov_Performance_lab/4/allure/#">Allure report</a>
...
## <img src="images/logo/Telegram.svg" width="25" height="25"  alt="Allure"/></a> Интеграция уведомлений с <a target="_blank" href="https://t.me/autotestsKrysov/49">Telegram</a>
